...
;bar
[chara_new  name="bar" storage="chara/bar/normal.png" jname="酒保"  ]
;隱藏菜單按鈕
[showmenubutton]
...
[glink  color="black"  storage="scene3.ks"  size="20"  x="260"  width="400"  y="150"  text="紅酒"  target="*j3"  ]
[glink  color="black"  storage="scene3.ks"  size="20"  x="260"  width="400"  y="220"  text="養樂多"  target="*j4"  ]
[s  ]
